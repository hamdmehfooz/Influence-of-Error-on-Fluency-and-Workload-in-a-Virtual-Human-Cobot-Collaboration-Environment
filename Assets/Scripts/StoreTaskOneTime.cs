...
public class StoreTaskOneTime : MonoBehaviour
{
    ...
    void StopTimer()
    {
        ...
        File.AppendAllText(filePath, $"Task 1,{DateTime.Now:yyyy-MM-dd HH:mm:ss},{minutes},{seconds},{milliseconds}\n");
    }
}

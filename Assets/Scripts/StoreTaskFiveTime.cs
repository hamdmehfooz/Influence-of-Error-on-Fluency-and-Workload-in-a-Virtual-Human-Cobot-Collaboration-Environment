...
public class StoreTaskFiveTime : MonoBehaviour
{
    ...
    void StopTimer()
    {
        ...
        File.AppendAllText(filePath, $"Task 5,{DateTime.Now:yyyy-MM-dd HH:mm:ss},{minutes},{seconds},{milliseconds}\n");
    }
}

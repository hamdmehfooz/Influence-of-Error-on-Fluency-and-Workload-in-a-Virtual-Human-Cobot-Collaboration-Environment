...
public class StoreTaskFourTime : MonoBehaviour
{
    ...
    void StopTimer()
    {
        ...
        File.AppendAllText(filePath, $"Task 4,{DateTime.Now:yyyy-MM-dd HH:mm:ss},{minutes},{seconds},{milliseconds}\n");
    }
}
